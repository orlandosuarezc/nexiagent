 ...
 * as well as build features in Nexiagent directly for a specific model or capabilities.
 *
...
/**
 * Returns the user agent for the Nexiagent deployment.
 * @returns {string} The user agent.
 */
function getNexiagentUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `Nexiagent/${version}`;
}
