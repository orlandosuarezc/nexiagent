            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  <p>
                    Funcionalidades experimentales de Nexiagent son características que
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Posibles errores o problemas usando Nexiagent.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configuraciones o suscripciones de Nexiagent.
                      </li>
                      <li>
